...
-- declared in the SampleForm.hs file.
module Settings
    ( hamletFile
    , cassiusFile
    , juliusFile
...
--
-- If you change the resource pattern for StaticR in SampleForm.hs, you will
-- have to make a corresponding change here.
--
-- To see how this value is used, see urlRenderOverride in SampleForm.hs
staticroot :: Text
