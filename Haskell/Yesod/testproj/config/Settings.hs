...
-- declared in the testproj.hs file.
module Settings
    ( hamletFile
    , cassiusFile
    , juliusFile
...
--
-- If you change the resource pattern for StaticR in testproj.hs, you will
-- have to make a corresponding change here.
--
-- To see how this value is used, see urlRenderOverride in testproj.hs
staticroot :: Text
